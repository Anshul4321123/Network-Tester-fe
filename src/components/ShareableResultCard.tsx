  ...
  const downloadAsImage = async () => {
    try {
      ...
      if (cardRef.current) {
        ...
        link.download = `speed-test-${new Date().toISOString().slice(0, 19)}.png`;
        link.href = dataUrl;
        link.click();
      }
    } catch (err) {
      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: "center", marginBottom: "clamp(16px, 4vw, 24px)" }}>
            <div style={{ fontSize: "clamp(40px, 10vw, 48px)", marginBottom: "8px" }}>🌐</div>
            <div style={{ fontSize: "clamp(16px, 4vw, 20px)", fontWeight: "bold", letterSpacing: "1px" }}>
              SPEED TEST RESULTS
            </div>
          ...
          >
            Generated by Speed Test App • Results may vary
          </div>
        </div>
